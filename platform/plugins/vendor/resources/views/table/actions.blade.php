<div class="table-actions">
    ...
    @if (!empty($delete))
        <a href="#" class="btn btn-icon btn-sm btn-primary deleteDialog" data-section="{{ route($delete, $item->id) }}" role="button" data-original-title="{{ trans('core/base::tables.delete_entry') }}" >
