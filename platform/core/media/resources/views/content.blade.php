    ...
    <div class="rv-media-wrapper">
        ...
        <div class="rv-media-main-wrapper">
            <header class="rv-media-header">
                <div class="rv-media-top-header">
                    <div class="rv-media-actions">
                        <label for="media_aside_collapse" class="btn btn-primary collapse-sidebar">
                        ...
                        @if (RvMedia::hasAnyPermission(['folders.destroy', 'files.destroy']))
                            <button class="btn btn-primary js-files-action hidden" data-action="empty_trash">
                ...
                <div class="rv-media-bottom-header">
                    ...
                    <div class="rv-media-tools">
                        ...
                        <div class="btn-group js-rv-media-change-view-type" role="group">
                            <button class="btn btn-primary" type="button" data-type="tiles">
                                <i class="fa fa-th-large"></i>
                            </button>
                            <button class="btn btn-primary" type="button" data-type="list">
            ...
            <footer class="rv-media-footer hidden">
                <button type="button" class="btn btn-primary btn-lg js-insert-to-editor">{{ trans('core/media::media.insert') }}</button>
            </footer>
        </div>
                        ...
                        <form class="rv-form form-add-folder">
                            <div class="input-group">
                                ...
                                <div class="input-group-prepend">
                                    <button class="btn btn-primary rv-btn-add-folder" type="submit">{{ trans('core/media::media.create') }}</button>
                                </div>
                            </div>
                        </form>
                        <div class="modal-notice"></div>
                ...
                <div class="modal-content">
                    <form class="rv-form form-rename">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary" data-dismiss-modal="#modal_rename_items">{{ trans('core/media::media.close') }}</button>
