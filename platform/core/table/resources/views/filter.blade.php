<div class="wrapper-filter">
    ...
    {{ Form::open(['method' => 'GET', 'class' => 'filter-form']) }}
        ...
        <div style="margin-top: 10px;">
            <a href="javascript:;" class="btn btn-primary add-more-filter">{{ trans('core/table::general.add_additional_filter') }}</a>
            <a href="{{ URL::current() }}" class="btn btn-primary @if (!request()->has('filter_table_id')) hidden @endif">{{ trans('core/table::general.reset') }}</a>
