...
class SendConsultRequest extends Request
{
    ...
    public function messages()
    {
        return [
            ...
            'g-recaptcha-response.required' => trans('plugins/real-estate::consult.g-recaptcha-response.required'),
            'g-recaptcha-response.captcha'  => trans('plugins/real-estate::consult.g-recaptcha-response.captcha'),
        ];
    }
}
