    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a class="float-left btn btn-primary" href="#" id="hide-widget-confirm-bttn">{{ trans('core/dashboard::dashboard.confirm_hide_btn') }}</a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            {!! Form::open(['route' => 'dashboard.hide_widgets']) !!}
                ...
                <div class="modal-footer">
                    <button class="btn btn-primary" data-dismiss="modal">{{ trans('core/base::forms.cancel') }}</button>
