@if ($contact)
    ...
    <p><button class="btn btn-primary answer-trigger-button">{{ __('Reply') }}</button></p>
    ...
    <div class="answer-wrapper">
        ...
        <div class="form-group">
            ...
            <button class="btn btn-primary answer-send-button"><i class="fas fa-reply"></i> {{ __('Send') }}</button>
        </div>
    </div>
@endif
