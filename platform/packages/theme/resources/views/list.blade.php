                                        ...
                                        <div class="col-12" style="background: #eee; padding: 15px;">
                                            ...
                                            <div>
                                                @if (setting('theme') == $key)
                                                    <a href="#" class="btn btn-primary" disabled="disabled"><i class="fa fa-check"></i> {{ trans('packages/theme::theme.activated') }}</a>
                                                @else
                                                    ...
                                                    @if (Auth::user()->hasPermission('theme.remove'))
                                                        <a href="#" class="btn btn-primary btn-trigger-remove-theme" data-theme="{{ $key }}">{{ trans('packages/theme::theme.remove') }}</a>
                                                    @endif
                                                @endif
                                            </div>
                                        </div>
