...
return [
    ...
    'file_too_big'                  => 'Archivo muy grande. El tamaño máximo para el archivo es de :size bytes',
    'can_not_detect_file_type'      => 'El tipo de archivo no es permitido o no se detecta el tipo del archivo!',
